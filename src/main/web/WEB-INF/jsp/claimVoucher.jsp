...
$(function () {
    ...
    $("#claimDg").datagrid({
        ...
        columns:[[
            ...
            {field:'id',title:'操作',align:'center',width:100,formatter:function (value,row,index) {
                var qbtn = "<button class='easyui-linkbutton' iconCls='icon-search' onclick='checkClaim("+value+")'>审核</button>";
                return qbtn;
            }}
        ]]
    });
